...
class MotoSport(Moto):
    def obtener_criterios_comparacion(self):
        return {
            ...
            'velocidad_maxima': self.rendimiento.top_speed if self.rendimiento else None,
    ...
    def obtener_tags_busqueda(self):
        ...
        if self.atributos_especificos.aceleracion_0_100 and self.atributos_especificos.aceleracion_0_100 < 4:
...
class MotoTouring(Moto):
    def obtener_criterios_comparacion(self):
        return {
            ...
            'tiene_parabrisas_ajustable': self.atributos_especificos.parabrisas_ajustable == "Sí",
            'tiene_maletas_laterales': self.atributos_especificos.maletas_laterales == "Sí",
            'suspension_ajustable': self.atributos_especificos.suspension_ajustable == "Sí",
    ...
    def obtener_tags_busqueda(self):
        ...
        if self.rendimiento and self.rendimiento.autonomia and self.rendimiento.autonomia > 400:
            tags.append('larga_distancia')
        if self.atributos_especificos.capacidad_maletas and self.atributos_especificos.capacidad_maletas > 30:
...
class MotoScooter(Moto):
    ...
    def obtener_tags_busqueda(self):
        ...
        if self.atributos_especificos.espacio_baul and self.atributos_especificos.espacio_baul >= 30:
            tags.append('baul_grande')
        if self.rendimiento and self.rendimiento.consumo and self.rendimiento.consumo > 40:
...
class MotoDoblePps(Moto):
    ...
    def obtener_tags_busqueda(self):
        ...
        if self.atributos_especificos.suspension_largo_recorrido and self.atributos_especificos.suspension_largo_recorrido > 150:
            tags.append('offroad_capable')
        if self.atributos_especificos.proteccion_motor == "Sí":
            tags.append('protegida')
        if self.rendimiento and self.rendimiento.autonomia and self.rendimiento.autonomia > 350:
            tags.append('gran_autonomia')
        return tags
...
class MotoMotocarro(Moto):
    ...
    def obtener_tags_busqueda(self):
        ...
        if self.atributos_especificos.capacidad_carga and self.atributos_especificos.capacidad_carga > 300:
            tags.append('carga_pesada')
        if self.atributos_especificos.capacidad_pasajeros and self.atributos_especificos.capacidad_pasajeros >= 3:
